...
class BackLayerMenuUser extends StatefulWidget {
  @override
  _BackLayerMenuUserState createState() => _BackLayerMenuUserState();
}

class _BackLayerMenuUserState extends State<BackLayerMenuUser> {
  @override
